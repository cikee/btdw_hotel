	...
	<html>
					...
					<div class="title">
						...
						<div class="box-tools" style="position: relative;">
							<div class="input-group" style="position:relative;left: 500px;width: 350px;height: 30px;">
								<input type="text" name="table-search" id="searchNameId" placeholder="入住人姓名"/>
							</div>
						...
						<table class="order-table">
							<thead id="first-thead">
								<tr><th><input type="checkbox" id="checkAll">全选</th>
									...
									<th class="th1">入住酒店</th>
									<th class="th1">订单编号</th>
									<th class="th1">客房类型</th>
									<th class="th1">入住时长</th>
									<th class="th1">入住地址</th>
									<th class="th1">酒店电话</th>
									<th class="th1">价格</th>
									<th class="th1">房间号</th>
								</tr>
							</thead>
		...
		$(function(){
		 ...
		 function doCreateTds(data){
			 var tds="<td><input type='checkbox' class='cBox' name='cItem' value='"+data.orderId+"'></td>"+
			 "<td>"+data.userName+"</td>"+
