...
Calendar.dayMouseDblClick = function(ev) {
	...
	if (Calendar.is_ie) {
		document.activeElement.value = '';/*document.selection.empty();更改双击时提示错误*/
	}
};
...
Calendar._TT["PREV_YEAR"] = "选择上一年。按住菜单,下拉选择年份";
Calendar._TT["PREV_MONTH"] = "选择上一月。按住菜单,下拉选择月份";
Calendar._TT["GO_TODAY"] = "选择本日";
Calendar._TT["NEXT_MONTH"] = "选择下一月。按住菜单,下拉选择月份";
Calendar._TT["NEXT_YEAR"] = "选择下一年。按住菜单,下拉选择年份";
