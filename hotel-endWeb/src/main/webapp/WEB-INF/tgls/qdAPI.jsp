			...
			<div class="layui-colla-item">
				...
				<div class="layui-colla-content">
					<button class="layui-btn"
						onmouseenter="getTips(this, '我是tips提示内容')"
						onmouseleave="layer.closeAll('tips')">tips提示功能</button>
					<textarea><button class="layui-btn"
							onmouseenter="getTips(this, '我是tips提示内容')"
							onmouseleave="layer.closeAll('tips')">tips提示功能</button></textarea>
					<div>
						<b>使用方法：</b><br /> 加入onmouseenter和onmouseleave事件函数即可。<br />
