	...
	<tr>
		<td class="big">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<div id='dhbt2' onClick=javascript:location= '?dqfx=all
							' style='cursor: hand'>
							<a href='?dqfx=all'>所有房间</a>
						</div>
						<div id='dhbt1' onClick=javascript:location= '?dqfx=普通标间
							' style='cursor: hand'>
							<a href='?dqfx=普通标间'>普通标间</a>
						</div>
						<div id='dhbt1' onClick=javascript:location= '?dqfx=单人间
							' style='cursor: hand'>
							<a href='?dqfx=单人间'>单人间</a>
						</div>
						<div id='dhbt1' onClick=javascript:location= '?dqfx=豪华标间
							' style='cursor: hand'>
							<a href='?dqfx=豪华标间'>豪华标间</a>
						</div>
						<div id='dhbt1' onClick=javascript:location= '?dqfx=三人间
							' style='cursor: hand'>
							<a href='?dqfx=三人间'>三人间</a>
						</div>
						<div id='dhbt1' onClick=javascript:location= '?dqfx=至尊皇帝套房
							' style='cursor: hand'>
							<a href='?dqfx=至尊皇帝套房'>至尊皇帝套房</a>
						</div>
	...
	<tr>
		<td>
			...
			<div id="fj_new01"
				...
				<div id="ps">
					<div class='ps_txt_div'>
						<a href='fj_kd.php?tid=574' class='ps_txt'>201<br>
						<span style='font-size: 12px; color: #666666;'>普通标间</span></a>
					</div>
				</div>
				<div id="wz">
			...
			<div id="fj_new01"
				...
				<div id="ps">
					<div class='ps_txt_div'>
						<a href='fj_kd.php?tid=559' class='ps_txt'>202<br>
						<span style='font-size: 12px; color: #666666;'>三人间</span></a>
					</div>
				</div>
				<div id="wz">
			...
			<div id="fj_new01"
				...
				<div id="ps">
					<div class='ps_txt_div'>
						<a href='fj_kd.php?tid=412' class='ps_txt'>8301<br>
						<span style='font-size: 12px; color: #666666;'>三人间</span></a>
					</div>
				</div>
				<div id="wz">
